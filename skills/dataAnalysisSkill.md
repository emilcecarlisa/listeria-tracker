...
- `initialResearch.md` - Initial exploration
- `dataComparisonAnalysis.md` - Comparative analysis
...
**Reference**: See `docs/gcpFy2024GeorgesFoodsIncident.md` for detailed NR vs MOI framework based on FSIS Directive 6110.1
...
2. **Markdown for analysis reports**: `docs/gcpLabJoinedAnalysis.md`
...
- **GCP Incident Analysis**: `docs/gcpFy2024GeorgesFoodsIncident.md`
- **Joined Dataset Analysis**: `docs/gcpLabJoinedAnalysis.md`
- **Consumption Analysis**: `docs/consumptionDataAnalysis.md`
- **Pork Sausage Analysis**: `docs/porkSausageAnalysis.md`
