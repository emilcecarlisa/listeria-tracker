...
1. **GCP Poultry Handling Data (FY2024)**
   - File: `data/0post-GCP_arch24.xlsx`
...
2. **Raw Poultry Laboratory Sampling Data (FY2025)**
   - File: `data/usda_fsis_data_product_establishment_specific_laboratory_sampling_raw_poultry_product_fy2025.json`
...
**Output File**: `data/joined_gcp_lab_poultry_data.csv`
...
**Reference**: See detailed incident report in `docs/8-gcp-fy2024-georges-foods-incident.md`
...
- **GCP Incident Report**: `docs/8-gcp-fy2024-georges-foods-incident.md` - Detailed analysis of George's Foods April 2024 incident and NR vs MOI framework
...
### Data Sources
- `data/0post-GCP_arch24.xlsx` - GCP Poultry Handling FY2024
- `data/usda_fsis_data_product_establishment_specific_laboratory_sampling_raw_poultry_product_fy2025.json` - Lab Sampling FY2025
- `data/joined_gcp_lab_poultry_data.csv` - **Output: Joined dataset for analysis**
